 ...
 * Slug: greg-grandin/page-link-in-bio-heading-paragraph-links-image
 * Categories: greg_grandin_page, banner, featured
 * Keywords: starter
	...
	<div class="wp-block-columns alignfull">
		...
		<div class="wp-block-column is-vertically-aligned-center">
			...
			<div class="wp-block-group" style="padding-top:var(--wp--preset--spacing--50);padding-right:var(--wp--preset--spacing--50);padding-bottom:var(--wp--preset--spacing--50);padding-left:var(--wp--preset--spacing--50)">
				<!-- wp:heading -->
				<h2 class="wp-block-heading"><?php esc_html_e( 'Lewis Hine', 'greg-grandin' ); ?></h2>
				<!-- /wp:heading -->

				<!-- wp:paragraph -->
				<p><?php esc_html_e( 'Lewis W. Hine studied sociology before moving to New York in 1901 to work at the Ethical Culture School, where he took up photography to enhance his teaching practices', 'greg-grandin' ); ?></p>
				<!-- /wp:paragraph -->
